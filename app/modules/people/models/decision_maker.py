"""DecisionMaker entity — a contact at a company we may reach out to."""
...
class DecisionMaker:
    """Contacts (email/linkedin/twitter/github/etc) live in a single dict for
    extensibility — easy to add new channels without schema migrations."""
...
class DecisionMakerNotFound(Exception):
