"""SQLA adapter for CandidateBundlesRepository.
...
class SqlaCandidateBundlesRepository(CandidateBundlesRepository):
    """Implements CandidateBundlesRepository over SQLAlchemy."""
