...
12-factor app approach. Same pattern used at Google, Meta, Netflix, banks, etc.
"""
...
class AppConfig:
    ...
    Safe to commit to git. Structured, nested, readable.
    """
    ...
    def get(self, path: str, default: Any = None) -> Any:
        """Dot-separated path lookup. e.g. config.get('enrichment.skip_fresh_days', 30)"""
        current = self._data
